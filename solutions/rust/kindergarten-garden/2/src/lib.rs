pub fn plants(diagram: &str, student: &str) -> Vec<&'static str> {
    ...
    let plants = vec![
        diagram.chars().nth(student_index*2),
        diagram.chars().nth(student_index*2+1),
        diagram.chars().nth(student_index*2+num_of_students*2+1),
        diagram.chars().nth(student_index*2+num_of_students*2+1+1)
    ];
